...
<head>
    ...
    <style>
        .notification {
            ...
            z-index: 9999;
            /* Ensure the notification appears on top */
        }
        ...
        <div data-elementor-type="wp-page" data-elementor-id="384" class="elementor elementor-384">
            ...
            <section
                ...
                <div class="elementor-container elementor-column-gap-no">
                    <div class="elementor-column  elementor-top-column elementor-element elementor-element-161dcde0"
                        data-id="161dcde0" data-element_type="column" style="width: 100%; justify-content: center;">
                                                    ...
                                                    <form id="registerForm" method="POST"
                                                        ...
                                                        <div style="display: flex; gap: 20px; flex-wrap: wrap;">
                                                            <div style="flex: 1; min-width: 250px;">
                                                                <label for="username"
                                                                    style="display: block; margin-bottom: 8px; color: #555; font-size: 14px; font-weight: 500;">Username</label>
                                                                <input type="text" id="username" name="username"
                                                                    required
                                                                    style="width: 100%; padding: 12px; border: 2px solid #e1e1e1; border-radius: 10px; font-size: 14px; transition: all 0.3s ease; outline: none; box-sizing: border-box;"
                                                                    onFocus="this.style.borderColor='#4A90E2'"
                                                                    onBlur="this.style.borderColor='#e1e1e1'">
                                                            </div>
                                                            <div style="flex: 1; min-width: 250px;">
                                                                <label for="full_name"
                                                                    style="display: block; margin-bottom: 8px; color: #555; font-size: 14px; font-weight: 500;">Full
                                                                    Name</label>
                                                        ...
                                                        <div style="display: flex; gap: 20px; flex-wrap: wrap;">
                                                            <div style="flex: 1; min-width: 250px;">
                                                                <label for="email"
                                                                    style="display: block; margin-bottom: 8px; color: #555; font-size: 14px; font-weight: 500;">Email</label>
                                                            ...
                                                            <div style="flex: 1; min-width: 250px;">
                                                                <label for="password"
                                                                    style="display: block; margin-bottom: 8px; color: #555; font-size: 14px; font-weight: 500;">Password</label>
                                                        ...
                                                        <div style="display: flex; gap: 20px; flex-wrap: wrap;">
                                                            <div style="flex: 1; min-width: 250px;">
                                                                <label for="phone_number"
                                                                    style="display: block; margin-bottom: 8px; color: #555; font-size: 14px; font-weight: 500;">Phone
                                                                    Number</label>
                                                            ...
                                                            <div style="flex: 1; min-width: 250px;">
                                                                <label for="company_name"
                                                                    style="display: block; margin-bottom: 8px; color: #555; font-size: 14px; font-weight: 500;">Company
                                                                    Name</label>
                                                        ...
                                                        <div style="display: flex; gap: 20px; flex-wrap: wrap;">
                                                            <div style="flex: 1; min-width: 250px;">
                                                                <label for="country"
                                                                    style="display: block; margin-bottom: 8px; color: #555; font-size: 14px; font-weight: 500;">Country</label>
                                                            ...
                                                            <div style="flex: 1; min-width: 250px;">
                                                                <label for="state"
                                                                    style="display: block; margin-bottom: 8px; color: #555; font-size: 14px; font-weight: 500;">State</label>
                                                        ...
                                                        <div style="display: flex; gap: 20px; flex-wrap: wrap;">
                                                            <div style="flex: 1; min-width: 250px;">
                                                                <label for="city"
                                                                    style="display: block; margin-bottom: 8px; color: #555; font-size: 14px; font-weight: 500;">City</label>
                                                            ...
                                                            <div style="flex: 1; min-width: 250px;">
                                                                <label for="postal_code"
                                                                    style="display: block; margin-bottom: 8px; color: #555; font-size: 14px; font-weight: 500;">Postal
                                                                    Code</label>
                                                        ...
                                                        <div style="display: flex; gap: 20px; flex-wrap: wrap;">
                                                            <div style="flex: 1; min-width: 250px;">
                                                                <label for="address_line1"
                                                                    style="display: block; margin-bottom: 8px; color: #555; font-size: 14px; font-weight: 500;">Address
                                                                    Line 1 (Optional)</label>
                                                        ...
                                                        <button type="submit"
                                                            style="width: 100%; padding: 10px; background-color: #e74901; color: #fff; border: none; border-radius: 5px; cursor: pointer; font-size: 16px;">
                                                            Register
                                                        </button>
                                                    </form>

                                                    <p
                                                        style="text-align: center; margin-top: 15px; font-size: 14px; color: #888;">
                                                        Already have an account? <a href="./login.php"
                                                            style="color: #e74901; text-decoration: none;">Login
                                                            here</a>.
                                                    </p>
                                                </div>
                                            </div>
        ...
        document.getElementById('registerForm').addEventListener('submit', function (event) {
            ...
            fetch('./backend/register.php', {
                ...
                .then(response => {
                    ...
                    return response.json(); // Ensure proper parsing of JSON response
                })
                .then(data => {
                    if (data.success) {
                        notify("Registration successful!", "success");
                    } else {
                        notify("Registration failed: " + (data.message || "Unknown error"), "error");
                    }
                })
                .catch(error => {
