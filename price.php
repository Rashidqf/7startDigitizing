...
<head>
	...
	<link rel="alternate" title="JSON" type="application/json" href="../wp-json/wp/v2/pages/385.json" />
	<link rel="EditURI" type="application/rsd+xml" title="RSD" href="../xmlrpc0db0.html?rsd" />
	<meta name="generator" content="WordPress 6.7.1" />
	<meta name="generator" content="WooCommerce 9.3.2" />
	<link rel="canonical" href="index.html" />
	<link rel='shortlink' href='../indexf1ac.html?p=385' />
	<link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed"
		href="../wp-json/oembed/1.0/embedd316.json?url=https%3A%2F%2Fz.commonsupport.com%2Flebulid%2Four-products%2F" />
	<link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed"
		href="../wp-json/oembed/1.0/embed2850?url=https%3A%2F%2Fz.commonsupport.com%2Flebulid%2Four-products%2F&amp;format=xml" />
	<noscript>
		<style>
...
<body
	class="page-template page-template-tpl-default-elementor page-template-tpl-default-elementor-php page page-id-385 theme-lebuild woocommerce-no-js menu-layer elementor-default elementor-kit-12 elementor-page elementor-page-385">
	...
	<div class="boxed_wrapper ">
		...
		<section class="breadcrumb-area" style="background-image: url(./wp-content/slider/sliderbg.jpg);">
			<div class="container">
				<div class="row">
					<div class="col-xl-12">
						<div class="inner-content">
							...
							<div class="breadcrumb-menu">
								<ul>
									...
									<li class="breadcrumb-item">Price Table
									</li>
								</ul>
							</div>
						</div>
		...
		<div data-elementor-type="wp-page" data-elementor-id="385" class="elementor elementor-385">
			<section
				class="elementor-section elementor-top-section elementor-element elementor-element-77ad132b elementor-section-full_width elementor-section-height-default elementor-section-height-default"
				data-id="77ad132b" data-element_type="section">
				<div class="elementor-container elementor-column-gap-no">
					<div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-73b9ebf4"
						data-id="73b9ebf4" data-element_type="column">
						<div class="elementor-widget-wrap elementor-element-populated">
							<div class="elementor-element elementor-element-1f43750f elementor-widget elementor-widget-lebuild_h1_blog"
								data-id="1f43750f" data-element_type="widget"
								data-widget_type="lebuild_h1_blog.default">
										...
										<div class="container">
											<div class="row text-right-rtl">
												...
												<div class="col-xl-4 col-lg-4">
													<div class="single-blog-style1 wow fadeInUp h-100"
														data-wow-duration="1500ms">
														<div class="text-holder d-flex flex-column h-100">
															<h3 class="blog-title">
																<a href="#">Vector Art</a>
															</h3>
															<h2 style="padding-bottom: 10px;">Start
																from $10</h2>
															<ul class="meta-info d-flex flex-column flex-grow-1"
																style="justify-content: center;">
																<li><i class="flaticon-check-mark"></i>Turnaround Time:
																	24-48 Hours</li>
																<li><i class="flaticon-check-mark"></i>Done by
																	Well-Trained People</li>
																<li><i class="flaticon-check-mark"></i>100% Satisfaction
																	Guaranteed</li>
																<li><i class="flaticon-check-mark"></i>No Overbilling or
																	Hidden Charges</li>
																<li><i class="flaticon-check-mark"></i>Free Conversion
																	to Other Formats</li>
																<li><i class="flaticon-check-mark"></i>Most Editing is
																	Free Until You Are Satisfied</li>
															</ul>
															<div>
															<?php if (isset($_SESSION['user_id'])): ?>
																<a href="<?php echo './dashboard/quickVectorForm.php'; ?>"
																	class="btn-one text-white">
																	<span class="txt">Contact Us <i
																			class="flaticon-right-arrow-1 arrow1"></i></span>
																</a>
															<?php else: ?>
												...
												<div class="col-xl-4 col-lg-4">
													<div class="single-blog-style1 wow fadeInUp h-100"
														...
														<div class="text-holder d-flex flex-column h-100">
															...
															<h2 style="padding-bottom: 10px;">Price:
																$10</h2>
															<ul class="meta-info d-flex flex-column flex-grow-1"
																style="justify-content: center;">
																<li><i class="flaticon-check-mark"></i>Turnaround Time:
																	8-24 Hours</li>
																<li><i class="flaticon-check-mark"></i>Digitized by
																	Well-Trained People</li>
																<li><i class="flaticon-check-mark"></i>100% Satisfaction
																	Guaranteed</li>
																<li><i class="flaticon-check-mark"></i>No Overbilling or
																	Hidden Charges</li>
																<li><i class="flaticon-check-mark"></i>Free Conversion
																	to Other Formats for Embroidery Designs</li>
																<li><i class="flaticon-check-mark"></i>Free Stitch
																	Estimates</li>
																<li><i class="flaticon-check-mark"></i>Most Editing is
																	Free Until You Are Satisfied</li>
																<li><i class="flaticon-check-mark"></i>Flexible Plans &
																	Pricing</li>
															</ul>
															<div>
															<?php if (isset($_SESSION['user_id'])): ?>
	...
	<script type="text/javascript" id="elementor-frontend-js-before">
		...
		var elementorFrontendConfig = {
			...
			"post": {
				"id": 385,
				"title": "View%20All%20News%20%E2%80%93%20lebulid",
				"excerpt": "",
				"featuredImage": false
			}
		};
