                                            ...
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    ...
                                                    <form id="loginForm" method="POST">
                                                        <label for="email"
                                                            style="display: block; margin-bottom: 5px; font-weight: bold; color: #555;">Email:</label>
                                                        ...
                                                        <label for="password"
                                                            style="display: block; margin-bottom: 5px; font-weight: bold; color: #555;">Password:</label>
                                                        ...
                                                        <p style="text-align: right; font-size: 14px; color: #888;">
                                                            <a href="<?php echo './forgot.php'; ?>"
                                                                style="color: #e74901; text-decoration: none;">Forgot
                                                                Password</a>.
                                                        </p>
                                                    ...
                                                    <p
                                                        ...
                                                        Don't have an account? <a href="<?php echo './register.php'; ?>"
                                                            style="color: #e74901; text-decoration: none;">Register
                                                            here</a>.
                                                    </p>
                                                </div>
                                            </div>
