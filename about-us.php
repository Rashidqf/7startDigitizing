...
<head>
	...
	<link rel='stylesheet' id='widget-google_maps-css'
		...
		media='all' />
	<link rel='stylesheet' id='elementor-post-376-css'
		href='wp-content/uploads/elementor/css/post-376ba18.css?ver=1727175867' type='text/css' media='all' />
	...
	<link rel="alternate" title="JSON" type="application/json" href="../wp-json/wp/v2/pages/376.json" />
	<link rel="EditURI" type="application/rsd+xml" title="RSD" href="../xmlrpc0db0.html?rsd" />
	<meta name="generator" content="WordPress 6.7.1" />
	<meta name="generator" content="WooCommerce 9.3.2" />
	<link rel="canonical" href="index.html" />
	<link rel='shortlink' href='../index264a.html?p=376' />
	<link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed"
		href="../wp-json/oembed/1.0/embed133a.json?url=https%3A%2F%2Fz.commonsupport.com%2Flebulid%2Fabout-us%2F" />
	<link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed"
		href="../wp-json/oembed/1.0/embede241?url=https%3A%2F%2Fz.commonsupport.com%2Flebulid%2Fabout-us%2F&amp;format=xml" />
	<noscript>
		<style>
...
<body
	class="page-template page-template-tpl-default-elementor page-template-tpl-default-elementor-php page page-id-376 theme-lebuild woocommerce-no-js menu-layer elementor-default elementor-kit-12 elementor-page elementor-page-376">
	...
	<div class="boxed_wrapper ">
		...
		<div data-elementor-type="wp-page" data-elementor-id="376" class="elementor elementor-376">
			<section
				class="elementor-section elementor-top-section elementor-element elementor-element-89b719c elementor-section-full_width elementor-section-stretched elementor-section-height-default elementor-section-height-default"
				data-id="89b719c" data-element_type="section"
				data-settings="{&quot;stretch_section&quot;:&quot;section-stretched&quot;}">
				<div class="elementor-container elementor-column-gap-no">
					<div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-a89828b"
						data-id="a89828b" data-element_type="column">
						<div class="elementor-widget-wrap elementor-element-populated">
							<div class="elementor-element elementor-element-dae07df elementor-widget elementor-widget-lebuild_h2_about"
								data-id="dae07df" data-element_type="widget"
								data-widget_type="lebuild_h2_about.default">
													...
													<div class="about-style2-content-box text-right-rtl">
														<div class="text-holder">
															<div class="sec-title">
																...
																<h2>providing top-notch embroidery digitizing services
																	since 1998.</h2>
															</div>
															<div class="inner-content">
																<h3>Team 7StarDigitizing
																</h3>
																<p>Team 7StarDigitizing has been in the embroidery digitizing industry since 1998. We strive to provide the best digitizing service possible, in the least amount of time, at the lowest price around. Our collective working experience in the embroidery field has enhanced our ability to provide quality digitized products at a competitive price.
																</p>
																<ul class="bgclr1">
														...
														<div class="img-box">
															<div data-animation-box class="main_image">
																<div data-animation-text
																	class="overlay-anim-black-bg inner"
																	data-animation="overlay-animation">

																	<img decoding="async"
																		src="wp-content/about-us/3.jpg" alt="" />
																</div>
																<div data-animation-text
																	class="overlay-anim-black-bg image_2"
																	data-animation="overlay-animation">
																	<img decoding="async"
																		src="wp-content/uploads/2021/09/circle-one.png"
																		alt="" />
																</div>
																<div data-animation-text
																	class="overlay-anim-black-bg image_3"
																	data-animation="overlay-animation">
																	<img decoding="async"
																		src="wp-content/about-us/2.jpg" alt="" />
																</div>

																<div data-animation-text
																	class="overlay-anim-black-bg image_4"
																	data-animation="overlay-animation">
																	<img decoding="async"
																		src="wp-content/about-us/2.jpg" alt="" />
																</div>
																<div data-animation-text
																	class="overlay-anim-black-bg image_5"
																	data-animation="overlay-animation">
																	<img decoding="async"
																		src="wp-content/about-us/1.jpg" alt="" />
																</div>
														...
														<div class="img-holder" style="position: relative;">
															<div class="inner">
																<img decoding="async" class="uniform-image"
																	src="./wp-content/products/product1.jpg"
																	alt="">
												...
												<div class="col-xl-4 col-lg-6 col-md-6">
													<div class="single-project-style1 wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
														<div class="img-holder" style="position: relative;">
															<div class="inner">
																<img decoding="async" class="uniform-image"
																	src="./wp-content/products/product2.jpg"
																	alt="">
																<div class="text-overlay"
																	style="position: absolute; bottom: 10px; left: 10px ; right: 10px; background: #e7490178; color: white; padding: 5px 10px; font-size: 16px; border-radius: 4px;">
												...
												<div class="col-xl-4 col-lg-6 col-md-6">
													<div class="single-project-style1 wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
														<div class="img-holder" style="position: relative;">
															<div class="inner">
																<img decoding="async" class="uniform-image"
																	src="./wp-content/products/product3.jpg"
																	alt="">
																<div class="text-overlay"
																	style="position: absolute; bottom: 10px; left: 10px ; right: 10px; background: #e7490178; color: white; padding: 5px 10px; font-size: 16px; border-radius: 4px;">
																	Prints for pocket-sized designs on shirts or jackets.
																</div>
																<div class="zoom-button">
																	<a class="lightbox-image" data-fancybox="gallery"
												...
												<div class="col-xl-4 col-lg-6 col-md-6">
													<div class="single-project-style1 wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
														<div class="img-holder" style="position: relative;">
															<div class="inner">
																<img decoding="async" class="uniform-image"
																	src="./wp-content/products/product4.jpeg"
																	alt="">
																<div class="text-overlay"
																	style="position: absolute; bottom: 10px; left: 10px ; right: 10px; background: #e7490178; color: white; padding: 5px 10px; font-size: 16px; border-radius: 4px;">
												...
												<div class="col-xl-4 col-lg-6 col-md-6">
													<div class="single-project-style1 wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
														<div class="img-holder" style="position: relative;">
															<div class="inner">
																<img decoding="async" class="uniform-image"
																	src="./wp-content/products/product5.avif"
																	alt="">
																<div class="text-overlay"
																	style="position: absolute; bottom: 10px; left: 10px ; right: 10px; background: #e7490178; color: white; padding: 5px 10px; font-size: 16px; border-radius: 4px;">
												...
												<div class="col-xl-4 col-lg-6 col-md-6">
													<div class="single-project-style1 wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
														<div class="img-holder" style="position: relative;">
															<div class="inner">
																<img decoding="async" class="uniform-image"
																	src="./wp-content/products/product6.png"
																	alt="">
																<div class="text-overlay"
																	style="position: absolute; bottom: 10px; left: 10px ; right: 10px; background: #e7490178; color: white; padding: 5px 10px; font-size: 16px; border-radius: 4px;">
												...
												<div class="col-xl-12">
													...
													<div
														...
														<div class="single-testimonial-style2">
															...
															<h4>Great service and quality prints! Highly recommended.</h4>
															<div class="bottom-box">
																...
																<div class="img-holder">
																	<img decoding="async"
																		src="wp-content/Reviews/slider.jpg"
																		alt="">
																</div>
															</div>
														</div>
														<div class="single-testimonial-style2">
															...
															<div class="bottom-box">
																...
																<div class="img-holder">
																	<img decoding="async"
																		src="wp-content/Reviews/slider1.jpg"
																		alt="">
																</div>
															</div>
														</div>
														<div class="single-testimonial-style2">
															...
															<div class="bottom-box">
																...
																<div class="img-holder">
																	<img decoding="async"
																		src="wp-content/Reviews/slider2.jpg"
																		alt="">
																</div>
															</div>
														</div>
														<div class="single-testimonial-style2">
															...
															<div class="bottom-box">
																...
																<div class="img-holder">
																	<img decoding="async"
																		src="wp-content/Reviews/slider3.jpg"
																		alt="">
																</div>
															</div>
														</div>
	...
	<script type="text/javascript" id="elementor-frontend-js-before">
		...
		var elementorFrontendConfig = {
			...
			"post": {
				"id": 376,
				"title": "About%20us%20%E2%80%93%20lebulid",
				"excerpt": "",
				"featuredImage": false
			}
		};
