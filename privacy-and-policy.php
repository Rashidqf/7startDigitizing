...
<body
	class="page-template page-template-tpl-default-elementor page-template-tpl-default-elementor-php page page-id-378 theme-lebuild woocommerce-no-js menu-layer elementor-default elementor-kit-12 elementor-page elementor-page-378">
						...
						<div class="inner-content">
							...
							<div class="breadcrumb-menu">
								<ul>
									...
									<li class="breadcrumb-item">Privacy policy
									</li>
								</ul>
							</div>
						</div>
														...
														<div class="sec-title">
															<div data-animation-container class="sub-title">
																<h5 data-animation-child class="title-fill"
																	data-animation="title-fill-anim">Privacy Policy</h5>
															</div>
															...
															<div class="text1">
																<p>Your personal information is protected. Your privacy is important to us and we take great care to protect it.</p>
															</div>
															<div class="text2">
																<p>7StarDigitizing.com does not publish or share your company information with any outside parties. All information will be transmitted securely and will not be released to any other organization. We use the information you provide lawfully and ethically. We are the sole owner of the information and will not sell, trade, rent or give away your details to any third parties unless we have your consent or are required to do so by law.</p>
															</div>
															<div class="text2">
																<p>7StarDigitizing.com web site do not ask or require credit card number or information at any stage of order process.If you have any Questions regarding above Privacy Policy should be directed to 7 Star Digitizing for clarification send us an email at <a
																href="mailto:admin@7stardigitizing.com">admin@7stardigitizing.com</a></p>
															</div>
															<h2 style="padding: 0px 0px 10px 0px; text-transform: capitalize; font-weight: 600;">Refund Policy

															</h2>
															<div class="text3">
																<p>If you are not 100% satisfied with your purchase, within 30 days from the purchase date, we will fully refund the cost of your order, send a scan copy of sample out to
																	<a
																		href="mailto:admin@7stardigitizing.com">admin@7stardigitizing.com</a>
																</p>
															</div>

															<div class="text4">
																<p>Customers are urged to run sample sew outs before moving to full production.
...
<!-- Mirrored from z.commonsupport.com/lebulid/services-details/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Jan 2025 07:08:04 GMT -->
