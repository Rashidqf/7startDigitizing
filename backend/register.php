...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO users (username, full_name, email, password, phone_number, company_name, country, state, postal_code, phone_extension, city, address_line1, address_line2)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    $stmt->bind_param("sssssssssssss", $username, $full_name, $email, $password, $phone_number, $company_name, $country, $state, $postal_code, $phone_extension, $city, $address_line1, $address_line2);
