...
<body
            ...
            <section
                ...
                <div class="elementor-container elementor-column-gap-no">
                    <div class="elementor-column  elementor-top-column elementor-element elementor-element-161dcde0"
                        ...
                        <div class="elementor-widget-wrap elementor-element-populated" style="width: 50%;">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    ...
                                                    <form id="forgotPasswordForm"
                                                        ...
                                                        <input
                                                            style="width: 100%; padding: 12px; margin-top: 30px; border: 2px solid #e1e1e1; border-radius: 10px; font-size: 14px; transition: all 0.3s ease; outline: none; box-sizing: border-box; margin-top: 15px"
                                                            type="email" id="email" placeholder="Enter your email"
                                                            required>
                                                        <button
                                                            style="width: 100%; padding: 10px; background-color: #e74901; color: #fff; border: none; border-radius: 5px; cursor: pointer; font-size: 16px;  margin-top: 15px"
                                                    ...
                                                    <form id="verifyOtpForm" style="display:none; ">
                                                        ...
                                                        <input
                                                            ...
                                                            style="width: 100%  margin-top: 15px" type="text" id="otp"
                                                    ...
                                                    <form id="resetPasswordForm" style="display:none;">
                                                        ...
                                                        <input
                                                            style="width: 100%; padding: 12px; border: 2px solid #e1e1e1; border-radius: 10px; font-size: 14px; transition: all 0.3s ease; outline: none; box-sizing: border-box; margin-top: 15px"
    ...
    <script>
        ...
        document.getElementById("verifyOtpForm").onsubmit = async function (e) {
            ...
            const button = document.querySelector("#verifyOtpForm button");

            // Disable button and show loader
            button.disabled = true;
            button.innerHTML = "Verifying... <span class='loader'></span>";
        ...
        document.getElementById("resetPasswordForm").onsubmit = async function (e) {
            ...
            button.disabled = true;
            button.innerHTML = "Resetting... <span class='loader'></span>";
